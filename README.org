...
* What is this?
  ...
  Although this is a fork from [[https://github.com/manateelazycat/awesome-tab][awesome-tab]] (that I forked with the permission from the author) it's been heavily modified so now it may be considered another package.
...
** Customize the modified marker
   ...
   #+END_SRC
   Also there are two faces to customize the close button string: centaur-tabs-closemodified-marker-unselected and centaur-tabs-closemodified-marker-selected
