...
** Buffer reordering
   ...
   | tab1.js | tab4.c | tab2.el | tab3.py |
 
   And then if you were on tab4.py and changed to ~tab2.js~,the tabs order will be the following:
   | tab1.js | tab4.c | tab2.el | tab3.py |

   the order doesn't changed ,because they already located next to each other.
   
   And now if you were on tab2.py and changed to ~tab1.js~,the tabs order will be the following:
   | tab4.js | tab1.c | tab2.el | tab3.py |
