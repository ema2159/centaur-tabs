...
** Buffer reordering
   ...
   If you're in a tab and change to another tab in the group (via tab clicking, Ido, Ivy or Helm) the tab you were in will move right beside your new tab, so if you're on ~tab1.el~ and you clicked ~tab4.py~ the tabs order will be the following:
